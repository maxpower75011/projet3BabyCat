//Récupérer ds fichier Json latitude/longitude pour chacun des vélos et injecter ds la variable marker pour afficher sur sur la map
	var mymap;
	var data;
	var ville = 'Nantes';
...
function onClick(e) {
	// pour faire qqch au clic sur marker
    //e.openPopup();
    //alert('ok');
}
